...
<?php
	...
	$class = "sco";
	$onglet = "Droits sco & grp";
	$titre = 'Gestion des droits des scolaires & groupes';
...
<form name="formu" method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>">
	...
	<p class="notes">
		...
		<ul>
			<li><?php echo intval($config["sco"]["right"]["view"]) ?> - Consultation simple</li>
			<li><?php echo intval($config["sco"]["right"]["mod"]) ?> - Ajout/modification/suppression</li>
			<li><?php echo intval($config["sco"]["right"]["param"]) ?> - Paramétrage du module</li>
		</ul>
	</p>
