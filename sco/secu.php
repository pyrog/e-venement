...
<?php
	...
	require_once($_SERVER["DOCUMENT_ROOT"].$config["website"]["root"]."sco/config.php");
	includeClass("bdRequest");
	includeClass("bd");
	
	// module inactif
	if ( !in_array("sco",$config["mods"]) )
	{
	...
	if ( !isset($user->scolevel) )
	{
		$query	= " SELECT level FROM sco.rights WHERE id = ".$user->getId();
