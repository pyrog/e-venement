...
EOF
  ...
  public function getDescription()
  {
    ...
    $seat = $this->seat_id
      ? 'seat $seat / '
      : '';
    return sprintf('%s<br/>%s %s<br/>(%s%s %s)', //<div class="batch-event">%s</div><div class="batch-manifestation"><span class="batch-happens_at">%s</span> <span class="batch-location">%s</span></div><div class="batch-details">(%s%s %s)</div>',
