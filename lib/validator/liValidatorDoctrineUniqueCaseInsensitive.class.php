...
class liValidatorDoctrineUniqueCaseInsensitive extends sfValidatorDoctrineUnique
{
  /**
   ...
   *  * case_sensitive:     Whether to check the value strictly or not (false by default)
   *
   * @see sfValidatorBase
   */
  protected function configure($options = array(), $messages = array())
  {
    $this->addOption('case_sensitive', false);
  ...
  protected function doClean($values)
  {
    ...
    foreach ($this->getOption('column') as $column)
    {
      ...
      $q->addWhere('a.' . $colName . ' ILIKE ?', $values[$column]);
    }
