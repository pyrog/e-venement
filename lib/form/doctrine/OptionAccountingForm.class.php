...
class OptionAccountingForm extends BaseOptionAccountingForm
{
  ...
  public function configure()
  {
    ...
    $this->widgets = array('' => array(
      ...
      'analytic_account'      => array('label' => 'Analytic account number',  'type' => 'string', 'options' => array('min_length' => 1, 'max_length' => 12)),
      ...
      'incomes_acc_vat'       => array('label' => 'Account for taxes',        'type' => 'string', 'options' => array('min_length' => 1, 'max_length' => 10)),
      'currency'              => array('label' => 'Currency',                 'type' => 'string', 'default' => 'EUR', 'options' => array('max_length' => 3, 'min_length' => 3)),
    ));
