...
[database]
dbtype = "pgsql"					; Type of database ("mysql", "mysqli" or "pgsql" are currently supported)
dbhost = "localhost"				; Name or IP of your database server
dbname = "contact"					; The name of the database
dbuser = "beta"				; The user to access the database
dbpass = "glop"				; The password to go with that username above
dbprefix = "fly_"				; The prefix to the Flyspray tables


[general]
cookiesalt = "12a160c01a3407c1c72f9327f26d4c46"			; Randomisation value for cookie encoding
...
doku_url = "http://fr.wikipedia.org/wiki/"      ; URL to your external wiki for [[dokulinks]] in FS
