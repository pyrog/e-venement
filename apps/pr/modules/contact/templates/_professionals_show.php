...
<div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all professional">
  <div class="ui-widget-header ui-corner-all fg-toolbar"><h2><?php echo __('Organism').': '.link_to($professional->Organism,'organism/show?id='.$professional->organism_id) ?></h2></div>
