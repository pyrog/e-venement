...
<?php
  ...
  /**
    ...
    **/
    ...
    if ( $tid = $this->getUser()->hasAttribute('transaction_id')
      ? $this->getUser()->getAttribute('transaction_id')
      : $this->getUser()->getAttribute('old_transaction_id') )
    {
      return $this->renderText(wsConfiguration::formatData(
        array('transaction',$tid)
      ));
    }
