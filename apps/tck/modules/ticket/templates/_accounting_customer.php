<div id="customer">
  ...
  <p class="address inline-modifiable"><?php echo ucwords(strtolower($transaction->professional_id ? $transaction->Professional->Organism->address : $transaction->Contact->address)) ?></p>
