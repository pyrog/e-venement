...
<td class="user"><?php echo $version->automatic ? '('.$version->user.')' : $version->user ?></td>
...
<td class="printed boolean"><?php echo image_tag( $version->printed_at || $version->integrated_at ? '/sfDoctrinePlugin/images/tick.png' : '/sfDoctrinePlugin/images/delete.png') ?></td>
