...
<div class="ui-widget-content ui-corner-all sf_admin_edit">
  ...
  <div class="ui-corner-all ui-widget-content action" id="topay">
    <?php $ticks = array(); foreach ( $transaction->Tickets as $ticket ) if ( is_null($ticket->duplicate) ) $ticks[$transaction->type == 'cancelling' ? $ticket->cancelling : $ticket->id] = $ticket->value; ?>
