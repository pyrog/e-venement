...
<div class="manifestation-ical" title="<?php echo __('Flash me to complete your calendar...') ?>">
  ...
  <a href="<?php echo url_for('manifestation/ical?id='.$manifestation->id) ?>"><img src="data:image/png;base64,<?php echo base64_encode($qrcode->render(NULL, 4, QR_ECLEVEL_L)) ?>" alt="iCal" /></a>
</div>
<?php endif ?>
