...
<form class="fg-button ui-widget ui-corner-all ui-state-default" action="<?php echo url_for(sfContext::getInstance()->getModuleName().'/search') ?>" method="get" id="list-integrated-search">
