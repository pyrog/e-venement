    <a
      ...
      href="#<?php echo isset($object) ? '' : 'update-filters' ?>" onclick="javascript: $('#tdp-side-bar .filters').submit(); return false;" id="tdp-update-filters" title="<?php echo __('Update filters') ?>"><?php echo __('Validate',null,'sf_admin') ?></a><?php
    ...
    ?><?php include_partial('global/tdp/filters_module_actions', array('hasFilters' => $hasFilters, 'object' => $object, 'filters' => $filters)) ?>
