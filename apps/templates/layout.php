...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body class="<?php echo 'app-'.$sf_context->getConfiguration()->getApplication().' mod-'.$module_name.' action-'.$sf_context->getActionName() ?> culture-<?php echo $sf_user->getCulture() ?>">
    <div id="content">
      <?php echo $sf_content ?>
    </div>
