...
<div class="sf_admin_form_row">
  ...
  <?php foreach ( $member_card->Payments as $payment ): ?>
    <tr>
      <td><?php echo cross_app_link_to('#'.$payment->transaction_id,'tck',($member_card->transaction_id && $member_card->Transaction->BoughtProducts->count() > 0 || $payment->Transaction->Tickets->count() > 0 ? 'transaction/edit' : 'ticket/pay').'?id='.$payment->transaction_id) ?></td>
