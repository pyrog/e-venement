...
<?php include_partial('global/tdp/top_widget',array('filters' => $filters, 'hasFilters' => $hasFilters, 'configuration' => $configuration, 'object' => NULL, 'config' => sfConfig::get('tdp_config_list'), 'noFilters' => $noFilters)) ?>
