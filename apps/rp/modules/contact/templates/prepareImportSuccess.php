...
<div class="ui-widget ui-widget-content ui-corner-all tdp-import">
  ...
  <div class="tdp-explanation ui-widget-content ui-corner-all">
    ...
    <pre>
ID,ETABLISSEMENT,PRENOM,NOM,ADRESSE1,ADRESSE2,CP,VILLE,GROUPE,TELEPHONE,EMAIL,LANGUAGE
1,DCAP,Marie-Claire,DURAND,MAIRIE D'ECHIROLLES,,38130,ECHIROLLES,ASSOCULT,0707070707,contact@ville-echirolles.fr
2,"CULTURES DU CŒUR",Jeanne,CHANCELLE,11 RUE DOCTEUR LAENNEC,,38610,GIERES,ASSOCULT,04 76 24 08 48,culturesducoeur@free.fr,en
3,"",Christian,MAJEUR,9 ALLEE DES LAURIERS,,69300,CALUIRE,AUTEUR,,,en
    </pre>
