...
<?php
    ...
    elseif ( $this->month_view )
      ...
      $q->andWhere("(me.hide_in_month_calendars = FALSE OR m.duration > ? OR DATE_TRUNC('day', m.reservation_begins_at) != DATE_TRUNC('day', m.reservation_ends_at) AND m.duration > ?)", array(24*60*60, 18*60*60 ,));
    if ( $no_ids )
