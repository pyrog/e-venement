    <td class="name"><?php echo cross_app_link_to($transac->Contact,'rp','contact/show?id='.$transac->contact_id) ?> <span class="pictos"><?php echo $transac->Contact->getRaw('groups_picto') ?></span></td>
