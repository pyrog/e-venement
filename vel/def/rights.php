...
<?php
	...
	$class = "vel";
	$onglet = "Droits VEL";
	$titre = 'Gestion des droits du module de vente en ligne.';
...
<form name="formu" method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>">
	...
	<p class="notes">
		...
		<ul>
			<li><?php echo intval($config["vel"]["right"]["view"]) ?> - Consultation simple</li>
			<li><?php echo intval($config["vel"]["right"]["mod"]) ?> - Ajout/modification/suppression</li>
			<li><?php echo intval($config["vel"]["right"]["param"]) ?> - Paramétrage du module</li>
		</ul>
	</p>
