...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="'.image_path('/sfFormExtraPlugin/images/'.$unassociate_image).'" alt="unassociate" />');
    $this->addOption('associate', '<img src="'.image_path('/sfFormExtraPlugin/images/'.$associate_image).'" alt="associate" />');
