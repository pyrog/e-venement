        ...
        <table align="center" class="sf_admin_pagination">
          <tbody>
            <tr>
              ...
              <td align="center">
                [?php echo __('Page') ?]
                <input type="text" onkeypress="javascript: if(event.keyCode == 13){ window.location = '<?php echo $this->getUrlForAction('list') ?>?page='+this.value; this.form.onsubmit = function(){ return false;}; }" name="page" value="[?php echo $pager->getPage() ?]" maxlength="7" size="2" />
