 ...
 * @version 0.4.8
*/
	class vCardBase implements Countable, Iterator
	{
		 ...
		 */
		protected $Mode;  //single, multiple, error
		 ...
		 */
		protected static $Spec_StructuredElements = array(
		...
		protected static $Spec_MultipleValueElements = array('nickname', 'categories');

		protected static $Spec_ElementTypes = array(
		...
		protected static $Spec_FileElements = array('photo', 'logo', 'sound');
		...
		protected static function PrepareTypeStrForOutput($Type)
		{
		 ...
		 */
		protected static function ParseStructuredValue($Text, $Key)
		{
		 ...
		 * @access private
		 */
		protected static function ParseMultipleTextValue($Text)
		{
			return explode(',', $Text);
		}
