...
<div class="%class%">
  ...
  <script type="text/javascript">
    var %js_instance_name% = new CxOpenSelect('%class%', '%src_id%', '%dest_id%', '%url%', %config%, %option_factory%);
  </script>
</div>
EOF
);
  ...
  public function getStylesheets()
  {
    ...
    sfContext::getInstance()->getResponse()->addStylesheet('/cxFormExtraPlugin/css/cx_open_list.css');
    return array();
  }
